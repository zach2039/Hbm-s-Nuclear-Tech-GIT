package com.hbm.tileentity.machine.pwr;
...
public class TileEntityMachinePWRCore extends TileEntity implements ITickable, IFluidHandler, ITankPacketAcceptor {
	...
	public TileEntityMachinePWRCore() {
